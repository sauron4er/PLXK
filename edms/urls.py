...
from edms.views import edms_get_doc_types, change_text_module, edms_get_free_times, get_it_tickets, get_doc_type_versions, get_all_employees, \
    ...
    get_client_requirements_for_choose, get_cr
from docs.views_contracts import get_contract, get_next_sequence_number, get_last_ten_reg_numbers, get_next_additional_contract_number
...
urlpatterns = [
    ...
    re_path(r'^my_docs/get_next_sequence_number/$', get_next_sequence_number, name='get_next_sequence_number'),
    re_path(r'^my_docs/get_last_ten_reg_numbers/$', get_last_ten_reg_numbers, name='get_last_ten_reg_numbers'),
