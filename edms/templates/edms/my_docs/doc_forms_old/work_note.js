...
class WorkNote extends React.Component {
  ...
  onChange = (event) => {
    if (event.target.name === 'chief_recipient') {
  ...
  render() {
    return (
      <Modal visible={this.state.open} width='45%' effect='fadeInUp'>
            ...
            <Form onSubmit={(e) => this.newWorkNote(e, 'post')}>
              <div className='modal-body'>
                ...
                <label>
                  ...
                  <Select
                    id='to_chief_select'
                    name='chief_recipient'
                    className='form-control full_width'
                    value={this.state.chief_recipient}
                    onChange={this.onChange}
                    validations={[required_not_0]}
                  >
                    <option data-key={0} value='0'>
                      ------------
                    </option>
              ...
              <div className='modal-footer'>
                ...
                <button
                  ...
                  onClick={(e) => this.newWorkNote(e, 'draft')}
                >
