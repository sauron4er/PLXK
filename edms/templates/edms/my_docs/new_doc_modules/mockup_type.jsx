...
class MockupType extends React.Component {
  ...
  onChange = (event) => {
    ...
    newDocStore.mockup_type_id = event.target.options[selectedIndex].getAttribute('data-key');
    newDocStore.mockup_type_name = event.target.options[selectedIndex].getAttribute('value');
  };
        ...
        <When condition={!loading}>
          <div className='row align-items-center mt-1 mr-lg-1'>
            ...
            <select
              ...
              id='mockup_type'
              name='mockup_type'
              value={newDocStore.mockup_type_name}
