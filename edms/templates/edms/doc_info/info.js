        ...
        <div>
          ...
          <If condition={this.props.info.path}>
            ...
            <div className="d-flex justify-content-between">
              ...
              <span>
                №: {this.props.doc.id}. Дата: {this.props.doc.date}
              </span>
            </div>
            <div>
              Автор:
              <div className="font-italic">{this.props.doc.author}</div>
            </div>
            ...
            <Choose>
                    ...
                    <table className="table table-bordered mt-2">
                      ...
                      <tbody>
                        <For
                          each="item"
                          index="idx"
                          of={this.props.info.carry_out_items}
                        >
                          <tr key={idx}>
                            <td>{idx + 1}</td>
              ...
              <When condition={this.props.doc.type_id === 3}>
                <div>
                  Кому:
                  <div className="font-italic ml-1">
                    {this.props.info.recipient},{" "}
                    {this.props.info.recipient_seat}
                  </div>
                  <div>Зміст:</div>
                  <div className="css_note_text ml-1">
                    {this.props.info.text}
                  </div>
                </div>
              </When>
              <When condition={this.props.doc.type_id === 4}>
                <div className="css_note_text ml-1">
                  ...
                  <Articles articles={info.articles} />
                </div>
              </When>
            </Choose>
