...
class Cost_Rates_Rate(models.Model):
    ...
    field = models.ForeignKey(Cost_Rates_Nom, related_name='cost_rates', on_delete=models.RESTRICT)
    term = models.CharField(max_length=10, null=True, blank=True)
    norm_for_one_t = models.CharField(max_length=10, null=True, blank=True)
...
#     date_start = models.CharField(max_length=30)
#     water_tech = models.CharField(max_length=10, null=True, blank=True)
#     pyrolisys_raw = models.CharField(max_length=10, null=True, blank=True)
#     comp_air = models.CharField(max_length=10, null=True, blank=True)
#     electricity = models.CharField(max_length=10, null=True, blank=True)
#     charcoal = models.CharField(max_length=10, null=True, blank=True)
#     wheat_flour = models.CharField(max_length=10, null=True, blank=True)
#     rye_flour = models.CharField(max_length=10, null=True, blank=True)
#     wheat_fodder = models.CharField(max_length=10, null=True, blank=True)
#     corn_starch = models.CharField(max_length=10, null=True, blank=True)
#     sodium_hydroxide = models.CharField(max_length=10, null=True, blank=True)
#     filler_modifier = models.CharField(max_length=10, null=True, blank=True)
#     sodium_chloride = models.CharField(max_length=10, null=True, blank=True)
#     paper_bag = models.CharField(max_length=10, null=True, blank=True)
#     thread = models.CharField(max_length=10, null=True, blank=True)
#     pallet = models.CharField(max_length=10, null=True, blank=True)
#     stretch = models.CharField(max_length=10, null=True, blank=True)
#     self_adhesive_label = models.CharField(max_length=10, null=True, blank=True)
#     a4 = models.CharField(max_length=10, null=True, blank=True)
#     cardboard = models.CharField(max_length=10, null=True, blank=True)
#     cardboard_gasket = models.CharField(max_length=10, null=True, blank=True)
#     carton_box = models.CharField(max_length=10, null=True, blank=True)
#     paper_partition = models.CharField(max_length=10, null=True, blank=True)
#     cover_p_e = models.CharField(max_length=10, null=True, blank=True)
#     staple = models.CharField(max_length=10, null=True, blank=True)
#     bags_p_e = models.CharField(max_length=10, null=True, blank=True)
#     paraffin = models.CharField(max_length=10, null=True, blank=True)
#     charcoal_briquette = models.CharField(max_length=10, null=True, blank=True)
#     small_box = models.CharField(max_length=10, null=True, blank=True)
#     paper_towel = models.CharField(max_length=10, null=True, blank=True)
#     aluminium_pallet = models.CharField(max_length=10, null=True, blank=True)
#     grill_stand = models.CharField(max_length=10, null=True, blank=True)
...
#     grill = models.CharField(max_length=10, null=True, blank=True)
#     scotch = models.CharField(max_length=10, null=True, blank=True)
#     pallet_used = models.CharField(max_length=10, null=True, blank=True)
#     solvents = models.CharField(max_length=10, null=True, blank=True)
#     acetic_acid = models.CharField(max_length=10, null=True, blank=True)
#     ethanol = models.CharField(max_length=10, null=True, blank=True)
#     KFK_80 = models.CharField(max_length=10, null=True, blank=True)
#     urea = models.CharField(max_length=10, null=True, blank=True)
#     water = models.CharField(max_length=10, null=True, blank=True)
#     salt = models.CharField(max_length=10, null=True, blank=True)
#     caustic_sodium = models.CharField(max_length=10, null=True, blank=True)
#     ammonioum_chloride = models.CharField(max_length=10, null=True, blank=True)
#     melamine = models.CharField(max_length=10, null=True, blank=True)
#     formic_acid = models.CharField(max_length=10, null=True, blank=True)
#     triethanolamine = models.CharField(max_length=10, null=True, blank=True)
#     polyvinyl_alcohol = models.CharField(max_length=10, null=True, blank=True)
#     kaolin = models.CharField(max_length=10, null=True, blank=True)
#     river_water = models.CharField(max_length=10, null=True, blank=True)
#     boric_acid = models.CharField(max_length=10, null=True, blank=True)
#     defoamer = models.CharField(max_length=10, null=True, blank=True)
#     orthophosphoric_acid = models.CharField(max_length=10, null=True, blank=True)
#     antiseptic = models.CharField(max_length=10, null=True, blank=True)
#     steam = models.CharField(max_length=10, null=True, blank=True)
#     wood_long_beech_PF = models.CharField(max_length=10, null=True, blank=True)
#     wood_long_sorted_PF = models.CharField(max_length=10, null=True, blank=True)
#     wood_long_sorted_PF_weight = models.CharField(max_length=10, null=True, blank=True)
#     wood_short_sorted_chipped_PF = models.CharField(max_length=10, null=True, blank=True)
#     pyrolisys_raw_PF_weight = models.CharField(max_length=10, null=True, blank=True)
#     pyrolisys_raw_beech_PF_weight = models.CharField(max_length=10, null=True, blank=True)
#     chips_bulk = models.CharField(max_length=10, null=True, blank=True)
#     wood = models.CharField(max_length=10, null=True, blank=True)
#     wood_beech = models.CharField(max_length=10, null=True, blank=True)
