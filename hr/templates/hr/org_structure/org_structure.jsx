...
function OrgStructure() {
  ...
  //TODO Редагування посади (назва, чи начальник, хто начальник)
  ...
  //TODO Додавання працівника на посаду
  //TODO Звільнення працівника з посади (з передачею документів і наказів іншому)

  //TODO На сторінці додавання працівника: галочка чи він користувач компа.
  // Якщо так - то автоматичне створення для нього юзера. Логін і пароль???
