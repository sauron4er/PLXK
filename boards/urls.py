...
urlpatterns = [
    ...
    url(r'^.+/reclamation_dep_chief_approval', views_reclamations.dep_chief_approval, name='reclamation_dep_chief_approval'),
    url(r'^.+/reclamation_post_new_comment', views_reclamations.post_new_comment, name='reclamation_post_new_comment'),
    url(r'^.+/reclamation_post_decision', views_reclamations.post_decision, name='reclamation_post_decision'),
    # url(r'^.+/reclamation_done', views_reclamations.done, name='reclamation_done'),
    ...
    url(r'^clients/get_table_first/(?P<meta_doc_type>\d+)/(?P<counterparty>\d+)/$', edms_get_table_first, name='get_table_first'),
    url(r'^clients/get_table_all/(?P<meta_doc_type>\d+)/(?P<counterparty>\d+)/$', edms_get_table_all, name='get_table_all'),
