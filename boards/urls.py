...
urlpatterns = [
    ...
    url(r'^.+/reclamation_dep_chief_approval', views_reclamations.dep_chief_approval, name='dep_chief_approval'),
    # url(r'^.+/post_new_comment', views_non_compliances.post_new_comment, name='post_new_comment'),
    url(r'^.+/reclamation_post_decision', views_reclamations.post_decision, name='post_decision'),
    # url(r'^.+/non_compliance_done', views_non_compliances.done, name='done'),
