                ...
                <div className='modal-body'>
                  ...
                  <If condition={contract.counterparty_old !== ''}>
                    ...
                    <If condition={edit_mode}>
                      <small className='text-danger'>
                        Це поле було заповнене без використання довідника контрагентів. Для того, щоб даний контракт відображався
                        на сторінці контрагента, будь ласка, оберіть його зі списку нижче і збережіть зміни.
                      </small>
                    </If>
                  </If>
                  <SelectorWithFilter
